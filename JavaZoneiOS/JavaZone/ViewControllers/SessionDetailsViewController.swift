...
class SessionDetailsViewController:  UIViewController  {
    ...
    override func viewDidLoad() {
        ...
        let startTime = CommonDate.formatDate(dateString: session!.startTime, dateFormat: "HH:mm")
        let endTime = CommonDate.formatDate(dateString: session!.endTime, dateFormat: "HH:mm")
    ...
    @objc func performSpeakerDetailSegue(sender: UITapGestureRecognizer) {
