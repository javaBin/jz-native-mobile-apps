...
package no.schedule.javazone.v3.archframework;
...
import static no.schedule.javazone.v3.util.PreconditionUtils.checkNotNull;
...
public abstract class ModelWithLoaderManager<Q extends QueryEnum, UA extends UserActionEnum>
     ...
     * LoaderManager.LoaderCallbacks#onLoadFinished(Loader, Object)} has fired, the
