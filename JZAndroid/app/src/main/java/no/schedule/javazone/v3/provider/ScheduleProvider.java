...
import no.schedule.javazone.v3.sync.ScheduleProviderUriMatcher;
import no.schedule.javazone.v3.sync.ScheduleUriEnum;
import no.schedule.javazone.v3.util.AccountUtils;
import no.schedule.javazone.v3.util.SelectionBuilder;
      ...
      case SEARCH_TOPICS_SESSIONS: {
        ...
        if (selectionArgs[0] != null) { // dont query if there was no selectionArg.
          search = query(ScheduleContract.Sessions.buildSearchUri(selectionArg),
              ...
              null, null,
              ScheduleContract.Sessions.SORT_BY_TIME);
        }
