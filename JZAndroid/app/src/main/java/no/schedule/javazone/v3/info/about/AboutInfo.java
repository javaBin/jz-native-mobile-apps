...
public class AboutInfo {
    ...
    private String aboutJavaZoneDescription;
    ...
    public String getAboutJavaZoneDescription() {
        return aboutJavaZoneDescription;
    }

    public void setAboutJavaZoneDescription(String aboutJavaZoneDescription) {
        this.aboutJavaZoneDescription = aboutJavaZoneDescription;
    }
}
