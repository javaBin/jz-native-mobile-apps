...
import static no.schedule.javazone.v3.util.FirebaseRemoteConfigUtil.getRemoteConfigSequence;
...
public class InfoPresenter implements InfoContract.Presenter {
    ...
    private void applyRemoteConfigToAboutInfo(AboutInfo aboutInfo) {
        ...
        String aboutJavaZone = getRemoteConfigSequence("faq_about_javazone");
        aboutInfo.setAboutJavaZoneDescription(aboutJavaZone);
    }
}