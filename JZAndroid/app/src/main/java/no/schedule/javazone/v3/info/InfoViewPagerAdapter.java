...
import no.schedule.javazone.v3.info.about.AboutFragment;
import no.schedule.javazone.v3.info.about.AboutInfo;
import no.schedule.javazone.v3.info.event.EventFragment;
import no.schedule.javazone.v3.info.event.EventInfo;
import no.schedule.javazone.v3.info.settings.SettingsFragment;
import no.schedule.javazone.v3.info.travel.TravelFragment;
import no.schedule.javazone.v3.info.travel.TravelInfo;
