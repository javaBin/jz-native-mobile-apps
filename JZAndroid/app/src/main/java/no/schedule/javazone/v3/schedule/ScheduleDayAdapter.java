...
import static no.schedule.javazone.v3.schedule.ScheduleItemViewHolder.SessionTimeFormat.DURATION;
...
public class ScheduleDayAdapter extends RecyclerView.Adapter<ViewHolder>
    ...
    private SessionItemViewHolder.Callbacks mAdapterCallbacks;

    public ScheduleDayAdapter(@NonNull Context context, @NonNull SessionItemViewHolder.Callbacks adapterCallbacks,
                              boolean showTimeSeparators) {
